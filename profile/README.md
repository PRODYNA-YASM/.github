...
Component Status overview. Last update 2024-06-21T09:37:19Z

| Repository | Commits | PRs | Latest Release |  [dev](https://dev-yasm.prodyna.com) |  [staging](https://staging-yasm.prodyna.com) |  [prod](https://yasm.prodyna.com) | 
| --- | --- | --- | -- |  --- |  --- |  --- | 
| [yasm-backend](https://github.com/prodyna-yasm/yasm-backend) | :red_square: [3](https://github.com/prodyna-yasm/yasm-backend/compare/1.32.0..HEAD) | :yellow_square: [3](https://github.com/prodyna-yasm/yasm-backend/pulls) | 1.32.0 |  :red_square: 6213f83 |  :green_square: 1.32.0 |  :green_square: 1.32.0 | 
| [yasm-frontend](https://github.com/prodyna-yasm/yasm-frontend) | :red_square: [6](https://github.com/prodyna-yasm/yasm-frontend/compare/1.32.0..HEAD) | :yellow_square: [7](https://github.com/prodyna-yasm/yasm-frontend/pulls) | 1.32.0 |  :red_square: 8435a3c |  :green_square: 1.32.0 |  :green_square: 1.32.0 | 
| [yasm-integration](https://github.com/prodyna-yasm/yasm-integration) | :green_square: 0 | :yellow_square: [1](https://github.com/prodyna-yasm/yasm-integration/pulls) | 1.33.0 |  :red_square: 38e65a4 |  :red_square: 1.32.1 |  :red_square: 1.32.1 | 
| [yasmctl](https://github.com/prodyna-yasm/yasmctl) | :green_square: 0 | :green_square: 0 | 1.33.0 |  :green_square: 1.33.0 |  :red_square: 1.32.0 |  :red_square: 1.32.0 | 
| [yasm-proxy-odbc](https://github.com/prodyna-yasm/yasm-proxy-odbc) | :green_square: 0 | :green_square: 0 | 1.15.0 |  :green_square: 1.15.0 |  :green_square: 1.15.0 |  :red_square: 1.14.0 | 
| [yasm-github](https://github.com/prodyna-yasm/yasm-github) | :green_square: 0 | :green_square: 0 | 1.5.1 |  :green_square: 1.5.1 |  :green_square: 1.5.1 |  :red_square: 1.5.0 | 
| [yasm-geocoding](https://github.com/prodyna-yasm/yasm-geocoding) | :red_square: [8](https://github.com/prodyna-yasm/yasm-geocoding/compare/1.9.13..HEAD) | :green_square: 0 | 1.9.13 |  :red_square: afa9400 |  :green_square: 1.9.13 |  :green_square: 1.9.13 | 
...
| [yasm-infrastructure-staged](https://github.com/prodyna-yasm/yasm-infrastructure-staged) | :red_square: [17](https://github.com/prodyna-yasm/yasm-infrastructure-staged/compare/1.30.0..HEAD) | :yellow_square: [3](https://github.com/prodyna-yasm/yasm-infrastructure-staged/pulls) | 1.30.0 |  :red_square: ce06eab |  :green_square: 1.30.0 |  :green_square: 1.30.0 | 
| [yasm-api](https://github.com/prodyna-yasm/yasm-api) | :green_square: 0 | :yellow_square: [3](https://github.com/prodyna-yasm/yasm-api/pulls) | 1.33.0 | 
...
| [yasm-test](https://github.com/prodyna-yasm/yasm-test) | :green_square: 0 | :yellow_square: [5](https://github.com/prodyna-yasm/yasm-test/pulls) | 1.30.1 | 
...
### [Commits on main since 1.32.0](https://github.com/prodyna-yasm/yasm-backend/compare/1.32.0..HEAD) (3)

- [feat(security): admin role to edit industries and skills,  maintainer role to edit organizations (#658)](https://github.com/prodyna-yasm/yasm-backend/commit/6213f8323267d5c030fdd4bcb91129d28b274b1f) by [coding4kay](https://github.com/coding4kay) on 2024-06-20 14:01:10 +0000 UTC

- [fix: check percent does't not export values over 100 (#656)](https://github.com/prodyna-yasm/yasm-backend/commit/2bfe37dfa22c6da4162ce9a3ef5f1ee2a7bd26e8) by [coding4kay](https://github.com/coding4kay) on 2024-06-19 13:58:00 +0000 UTC

- [feat: add person skill statistic endpoint (#655)](https://github.com/prodyna-yasm/yasm-backend/commit/c1046b6b0855693804acd145d9b076f3b98a8303) by [coding4kay](https://github.com/coding4kay) on 2024-06-19 08:56:52 +0000 UTC
...
- [Bump quarkus.platform.version from 3.11.2 to 3.11.3](https://github.com/PRODYNA-YASM/yasm-backend/pull/657)
...
### [Commits on main since 1.32.0](https://github.com/prodyna-yasm/yasm-frontend/compare/1.32.0..HEAD) (6)

- [Listing files after the run (#755)](https://github.com/prodyna-yasm/yasm-frontend/commit/8435a3c6bea9dacc394d57db274a9ee3e20dc25e) by [dkrizic](https://github.com/dkrizic) on 2024-06-21 08:48:29 +0000 UTC

- [chore: bump docker/build-push-action from 5 to 6 (#742)](https://github.com/prodyna-yasm/yasm-frontend/commit/36fafca513dd96c42db0d9c19c512cc2310d4124) by [dependabot[bot]](https://github.com/dependabot[bot]) on 2024-06-19 15:09:40 +0000 UTC

- [fix: fix version of yasm-test (#751)](https://github.com/prodyna-yasm/yasm-frontend/commit/e1b4dbc6c5ef8463914802ce50bbfc17f578f514) by [dkrizic](https://github.com/dkrizic) on 2024-06-19 15:03:36 +0000 UTC

- [feat: fix env var (#750)](https://github.com/prodyna-yasm/yasm-frontend/commit/1e24e748645a1424727092ec3a079cfb060c372d) by [dkrizic](https://github.com/dkrizic) on 2024-06-19 14:47:48 +0000 UTC

- [fix: Use ${{ env }} syntax (#749)](https://github.com/prodyna-yasm/yasm-frontend/commit/7d3dfec03e6c16aaaa59cb49ed15cfa741419bdb) by [dkrizic](https://github.com/dkrizic) on 2024-06-19 14:33:41 +0000 UTC

- [fix: Use correct version of yasm-test (#748)](https://github.com/prodyna-yasm/yasm-frontend/commit/6241bae2b64fbf7cfc1d781cd3601d4120e49fb3) by [dkrizic](https://github.com/dkrizic) on 2024-06-19 14:24:12 +0000 UTC
...
- [chore: bump @types/node from 20.14.0 to 20.14.7](https://github.com/PRODYNA-YASM/yasm-frontend/pull/753)
...
- [feat: Using API 1.33](https://github.com/PRODYNA-YASM/yasm-integration/pull/456)
...
- [Merge pull request #206 from PRODYNA-YASM/feature/technology-update](https://github.com/PRODYNA-YASM/yasm-proxy-odbc/actions/runs/9611518898) created on 2024-06-21 09:33:50 +0000 UTC
...
- [Merge pull request #100 from PRODYNA-YASM/feature/technology-update](https://github.com/PRODYNA-YASM/yasm-github/actions/runs/9611527301) created on 2024-06-21 09:34:27 +0000 UTC
...
### [Commits on main since 1.9.13](https://github.com/prodyna-yasm/yasm-geocoding/compare/1.9.13..HEAD) (8)

- [Merge pull request #123 from PRODYNA-YASM/feature/update-components](https://github.com/prodyna-yasm/yasm-geocoding/commit/afa940076ff65eab02c96040ea773fc65dbf2d2a) by [dkrizic](https://github.com/dkrizic) on 2024-06-20 09:47:44 +0000 UTC

- [Use current components](https://github.com/prodyna-yasm/yasm-geocoding/commit/0b4cdcfc05dc119beb7f71a2093c0f2eeb51c52e) by [dkrizic](https://github.com/dkrizic) on 2024-06-20 09:44:15 +0000 UTC

- [Merge pull request #122 from PRODYNA-YASM/dependabot/go_modules/github.com/go-chi/chi/v5-5.0.13](https://github.com/prodyna-yasm/yasm-geocoding/commit/555b85ebcc271922eadbc36019ce865908f3d864) by [dkrizic](https://github.com/dkrizic) on 2024-06-18 16:46:06 +0000 UTC

- [Bump github.com/go-chi/chi/v5 from 5.0.12 to 5.0.13](https://github.com/prodyna-yasm/yasm-geocoding/commit/cccd4150086ac3e75143d7e0bf2bbfecffa5bb67) by [dependabot[bot]](https://github.com/dependabot[bot]) on 2024-06-18 16:13:36 +0000 UTC
...
### [Commits on main since 1.30.0](https://github.com/prodyna-yasm/yasm-infrastructure-staged/compare/1.30.0..HEAD) (17)
...
- [Bump azurerm from 3.108.0 to 3.109.0 in /terraform/kubernetes](https://github.com/PRODYNA-YASM/yasm-infrastructure-staged/pull/551)

- [Bump azurerm from 3.108.0 to 3.109.0 in /terraform/azure](https://github.com/PRODYNA-YASM/yasm-infrastructure-staged/pull/550)
...
## [yasm-api](https://github.com/prodyna-yasm/yasm-api) 1.33.0
...
- [Skill statistic endpoint](https://github.com/PRODYNA-YASM/yasm-api/releases/tag/1.33.0) on 2024-06-19 08:36:50 +0000 UTC
...
- [chore(deps-dev): Bump @types/node from 20.14.2 to 20.14.6](https://github.com/PRODYNA-YASM/yasm-test/pull/103)

- [chore(deps): Bump cypress/included from 13.11.0 to 13.12.0](https://github.com/PRODYNA-YASM/yasm-test/pull/102)

- [chore(deps-dev): Bump cypress from 13.11.0 to 13.12.0](https://github.com/PRODYNA-YASM/yasm-test/pull/101)
